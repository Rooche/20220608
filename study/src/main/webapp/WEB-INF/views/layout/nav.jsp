...
<body>
	...
	<ul
		...
		<a
			...
			<div class="sidebar-brand-text mx-3">마이홈</div> <!-- 왼쪽위에 마이홈으로 바뀜 -->
		</a>
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					<a class="collapse-item" href="loginForm.do">로그인</a> <a
						class="collapse-item" href="#">멤버목록</a>
				</div>
			</div></li>
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			aria-expanded="true" aria-controls="collapseUtilities"> <i
				class="fas fa-fw fa-wrench"></i> <span>공지사항 관리</span>
		</a>
			<div id="collapseUtilities" class="collapse"
				aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
				<div class="bg-white py-2 collapse-inner rounded">
					<a class="collapse-item" href="noticeSelectList.do">공지사항</a> <a
